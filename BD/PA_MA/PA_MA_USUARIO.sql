...
===================================================================================================================================================
*/
CREATE PROCEDURE [DBO].[PA_MAN_USUARIO]
(
	...
	@P_CONTRASENA VARBINARY(max) =0,					/*CONTRASEÑA DEL USUARIO*/
    ...
    BEGIN TRY
            ...
            BEGIN --INICIO-VARIOS
                ...
                SELECT @V_ERR_PARAMETROS
                    = (
                                ...
                                ''''+
                                '@P_CONTRASENA='+
                                CAST(@P_CONTRASENA AS VARCHAR(50))
        ...
        BEGIN --INICIO-CUERPO PROCEDIMIENTO								   
            ...
            BEGIN
                ...
                SELECT @V_ERR_MENSAJE_USUARIO = 'ERROR AL SELECCIONAR EN LA TABLA TBL_SIMP_USUARIO';
			    ...
			    IF NOT EXISTS(SELECT 1 FROM  ' + @P_ESQUEMA
				 ...
				 WHERE PK_TBL_SIMP_SEG_USUARIO = @P_ID)
				 BEGIN
