...
EXEC dbo.PA_MAN_USUARIO		@P_USUARIO = '',            -- varchar(20)
							@P_MODO_EJECUCION = 0		-- varchar(20)
                            @P_OPCION = 0,              -- smallint
							@P_IDENTIFICADOR_EXTERO = ''-- varchar(50)

                            @P_ID = 0,					-- BIGINT
							@P_IDCLIENTE = 0,			-- BIGINT
							@P_IDESTADO = 0,			-- BIGINT
							@P_NOMBRE = '',				-- varchar(50)
...
===================================================================================================================================================
*/
CREATE PROCEDURE [DBO].[PA_MAN_PROYECTO]
(
    ...
    BEGIN TRY
            ...
            BEGIN --INICIO-VARIOS
                ...
                SELECT @V_ERR_PARAMETROS
                    = (
                                ...
                                ' , '+
								'@P_IDCLIENTE='+
                                CAST(@P_IDCLIENTE AS VARCHAR(50))+
                                ' , '+
								'@P_IDESTADO='+
        ...
        BEGIN --INICIO-CUERPO PROCEDIMIENTO								   
            ...
            BEGIN
                ...
                SELECT @V_ERR_MENSAJE_USUARIO = 'ERROR AL SELECCIONAR EN LA TABLA TBL_SIMP_PY_PROYECTO';
			    ...
			    IF NOT EXISTS(SELECT 1 FROM  ' + @P_ESQUEMA
                          + '.TBL_SIMP_PY_PROYECTO
				 WHERE PK_TBL_SIMP_PY_PROYECTO = @P_ID)
				 BEGIN
				 ...
				 (   @P_IDCLIENTE,
				  ...
				  BEGIN
				  UPDATE  ' + @P_ESQUEMA
							+ '.TBL_SIMP_PY_PROYECTO SET 
				     FK_TBL_SIMP_CLIENTE = @P_IDCLIENTE,
