...
FECHA:          <2022/09/16>
DESCRIPCION:   <SELECCIONA UsuariosxProyecto>
-------------------------------------------
=========================================COMPLETAR CON NUEVOS PARAMETROS============================================================================
EXEC dbo.PA_MAN_USUARIOXPROYECTO
...
===================================================================================================================================================
*/
CREATE PROCEDURE [DBO].[PA_MAN_USUARIOXPROYECTO]
(
    ...
    BEGIN TRY
            ...
            BEGIN --INICIO-VARIOS
                ...
                SELECT @V_ERR_PARAMETROS
                    = (
                                ...
                                ' , '+
								'@P_IDPROYECTO='+
                                CAST(@P_IDPROYECTO AS VARCHAR(50))+
                                ' , '+
								'@P_FECHA='+
                                CAST(@P_FECHA AS VARCHAR(50))
                            );
        ...
        BEGIN --INICIO-CUERPO PROCEDIMIENTO								   
            ...
            BEGIN
                ...
                SELECT @V_ERR_MENSAJE_USUARIO = 'ERROR AL SELECCIONAR EN LA TABLA TBL_SIMP_USUARIOXPROYECTO';
			    ...
			    IF NOT EXISTS(SELECT 1 FROM  ' + @P_ESQUEMA
                          + '.TBL_SIMP_USUARIOXPROYECTO
				 WHERE PK_FK_TBL_SIMP_USUARIO = @P_IDUSUARIO AND PK_FK_TBL_SIMP_PROYECTO = @P_IDPROYECTO)
				 BEGIN
				 INSERT INTO ' + @P_ESQUEMA
                          + '.TBL_SIMP_USUARIOXPROYECTO
				 (
				     PK_FK_TBL_SIMP_USUARIO,
