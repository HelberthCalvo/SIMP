...
*/
GO
CREATE PROCEDURE [dbo].[PA_CON_USUARIO]
(
     ...
     @P_IDROL BIGINT = 0,								/*FK DE LA TABLA ROL*/
        ...
        BEGIN --INICIO-CUERPO PROCEDIMIENTO
            ...
            BEGIN
                ...
                BEGIN
                    ...
                    SELECT @V_ERR_MENSAJE_USUARIO = 'ERROR AL EJECUTAR LA CONSULTA DE LA TABLA TBL_SIMP_USUARIO';

				SELECT	@SET_SQLSTRING =
				N'SELECT [PK_TBL_SIMP_SEG_USUARIO]
					  ,[FK_TBL_SIMP_ROL]
					  ,[FK_TBL_SIMP_ESTADO]
					  ,[NOMBRE]
					  ,[PRIMER_APELLIDO]
					  ...
					  ,[USUARIO]
					  ,[CONTRASENA]
				  FROM ' + @P_ESQUEMA + N'.[TBL_SIMP_SEG_USUARIO]
				  ORDER BY PK_TBL_SIMP_SEG_USUARIO asc'
				...
				N'SELECT [PK_TBL_SIMP_SEG_USUARIO]
					  ...
					  ,[USUARIO]
					  ,[CONTRASENA]
				  FROM ' + @P_ESQUEMA + N'.[TBL_SIMP_SEG_USUARIO] WHERE  ([PK_TBL_SIMP_SEG_USUARIO] =  @P_ID OR @P_ID = 0) 
				  AND ([FK_TBL_SIMP_ROL] = @P_IDROL OR @P_IDROL = 0)
