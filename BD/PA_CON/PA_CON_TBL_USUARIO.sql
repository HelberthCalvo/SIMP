        ...
        BEGIN --INICIO-CUERPO PROCEDIMIENTO
            ...
            BEGIN
				...
				N'SELECT [PK_TBL_SIMP_USUARIO]
					  ...
					  ,[USUARIO]
					  ,[CONTRASENA]
				  FROM ' + @P_ESQUEMA + N'.[TBL_SIMP_USUARIO]
				  ORDER BY PK_TBL_SIMP_USUARIO asc'
				...
				N'SELECT [PK_TBL_SIMP_USUARIO]
					  ...
					  ,[USUARIO]
					  ,[CONTRASENA]
				  FROM ' + @P_ESQUEMA + N'.[TBL_SIMP_USUARIO] WHERE  ([PK_TBL_SIMP_USUARIO] =  @P_ID OR @P_ID = 0) 
