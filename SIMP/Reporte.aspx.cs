        ...
        protected void gvProgresoProyecto_RowCommand(object sender, GridViewCommandEventArgs e)
        {
            ...
            try
            {
                if (e.CommandName == "GenerarPDF")
                {
                    ...
                    string rutaReportes = Server.MapPath("~/Reportes/");
                    string var_reporte = "ReportePorcentajeProyecto.rpt";

                    conex.Type = ConnectionInfoType.SQL;


                    ReportDocument rd = new ReportDocument();
                    rd.FileName = var_reporte;
                    rd.Load(rutaReportes+var_reporte);
